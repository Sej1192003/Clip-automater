...
MAX_VIDEOS_PER_CREATOR = 3       # how many recent videos to check per creator
MIN_VIRALITY_SCORE = 5           # out of 10, skip anything below this
...
VIRAL_KEYWORDS = [
    "money", "rich", "broke", "secret", "nobody tells you", "mistake",
    "never", "always", "warning", "truth", "stop", "start", "how i",
    "passive income", "financial freedom", "debt", "invest", "retire",
    "millionaire", "salary", "income", "budget", "savings", "stock",
    "real estate", "side hustle", "fired", "quit", "viral"
]
